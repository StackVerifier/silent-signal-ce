// AuthProvider now lives in the root layout so the dashboard shares one session.
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-dvh bg-gradient-to-br from-[#070B18] via-[#0F1824] to-[#070B18] flex items-center justify-center px-4 py-10">
